  ...
  function renderCart() {
    ...
    if (cart.length === 0) {
        ...
        cart.forEach(item => {
            ...
            // Creacion del icono de eliminar (SVG)
    ...
    document.body.appendChild(container); // Asegúrate de agregar el contenedor al body
}
...
function addToCart(viaje) {
    ...
    Swal.fire({
        title: `${viaje.name} se agregó al carrito!`,
        icon: 'success',
...
// Ejemplo de uso: llamando a la función para renderizar el carrito
document.addEventListener('DOMContentLoaded', renderCart);

function handlePagar(cart) {
    // Preguntar al usuario si desea realizar el pago o cancelarlo
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire({
                ...
                // Aquí puedes agregar la lógica para procesar el pago real, como llamar a una API de pago
                ...
                Swal.fire({
                    ...
                    // Renderizar nuevamente el carrito para mostrar que está vacío
                    renderCart();
                });
            });
        } else {
